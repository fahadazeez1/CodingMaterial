package com.example.Job_ms_1.Configs;

import com.example.Job_ms_1.Dtos.MessageResponseDto;
...
public class AdviceController {
    ...
    public ResponseEntity<MessageResponseDto> handleRuntimeException(ResponseStatusException ex, WebRequest request) {
        MessageResponseDto errorResponse = MessageResponseDto.builder()
                .timestamp(LocalDateTime.now())
